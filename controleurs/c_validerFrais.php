...
switch($action) {
    ...
    case "afficherVisiteursEtSixDerniersMois2": {
        $visiteurs = $pdo->afficherVisiteurs();
        $lesMois = getSixDerniersMois();
        $moisASelectionner = $lesMois[0]['year'].$lesMois[0]['month'];
        $visiteursASelectionner = $visiteurs[0]['id'];
        ...
        $fiche = $pdo->getinfofiche();
       
        
        
        
        include("vues/v_selectionnerVisiteurEtMois_1.php");
        break;
    }
    ...
    case 'Validerfiche':{
        ...
        $pdo->majEtatFicheFrais($visiteur,$leMois,$etat);
